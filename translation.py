...
<b>If The Above Is Checked Then The Yes Button Can Be Clicked</b>"""
  ...
  HEADER_MSG = "✏️ SEND HERE FOR ADD HEADER IN CAPTION.\n\n✏️ MY SAVED WORDS FOR HEADER :\n<code>{}</code>"
  FOOTER_MSG = "✏️ SEND HERE FOR ADD FOOTER IN CAPTION.\n\n✏️ MY SAVED WORDS FOR FOOTER :\n<code>{}</code>"
  PREFIX_MSG = "✏️ SEND HERE FOR ADD PREFIX IN CAPTION.\n\n✏️ MY SAVED WORDS FOR PREFIX :\n<code>{}</code>"
  SUFFIX_MSG = "✏️ SEND HERE FOR ADD SUFFIX IN CAPTION.\n\n✏️ MY SAVED WORDS FOR SUFFIX :\n<code>{}</code>"
  DELETE_BEFORE_MSG = "✏️ SEND HERE FOR ADD DELETE BEFORE IN CAPTION.\n\n✏️ MY SAVED WORDS FOR DELETE BEFORE :\n<code>{}</code>"
  DELETE_AFTER_MSG = "✏️ SEND HERE FOR ADD DELETE AFTER IN CAPTION.\n\n✏️ MY SAVED WORDS FOR DELETE AFTER :\n<code>{}</code>"
  DELETE_WORDS_MSG = "✏️ SEND HERE FOR ADD DELETE IN CAPTION.\n\n✏️ MY SAVED WORDS FOR DELETE :\n<code>{}</code>"
  REPLACE_WORDS_MSG = "✏️ SEND HERE FOR REPLACE IN CAPTION.\n\n〰️ MULTIPLE TEXTS SEPARATE BY ,\n〰️ SEPARATE KEY AND VALUE BY >>\n\n〰️ EX :- IF YOU WANT REPLACE RAS INTO IAS AND New delhi INTO jaipur THEN SEND ➠\nRAS>>IAS,New delhi>>jaipur\n\n✏️ MY SAVED WORDS FOR REPLACE :\n<code>{}</code>"
  LINK_REPLACE_MSG = "✏️ SEND HERE FOR ADD LINK REPLACE IN CAPTION.\n\n✏️ MY SAVED WORDS FOR LINK REPLACE :\n<code>{}</code>"
  USERNAME_REPLACE_MSG = "✏️ SEND HERE FOR ADD USERNAME REPLACE IN CAPTION.\n\n✏️ MY SAVED WORDS FOR USERNAME REPLACE :\n<code>{}</code>"
  CAPTION_LENGTH_MSG = "✏️ SEND HERE FOR ADJUST LENGTH IN CAPTION.\n\n〰️ IT MUST BE POSITIVE DIGIT.\n\n✏️ MY SAVED CAPTION LENGTH :\n<code>{}</code>"
